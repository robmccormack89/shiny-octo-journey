<?php
/**
 * Widget API: Shiny_Octo_Journey_Custom_UIKIT_Widget_Class class
 *
 */
 ...
 * @see WP_Widget
 */
class Shiny_Octo_Journey_Custom_UIKIT_Widget_Class extends WP_Widget
{
    ...
    public function _register_one($number = -1)
    {
        ...
        add_action('admin_footer-widgets.php', array( 'Shiny_Octo_Journey_Custom_UIKIT_Widget_Class', 'render_control_template_scripts' ));

        // Note this action is used to ensure the help text is added to the end.
        add_action('admin_head-widgets.php', array( 'Shiny_Octo_Journey_Custom_UIKIT_Widget_Class', 'add_help_text' ));
    }
    ...
    public function widget($args, $instance)
    {
         ...
         * @param Shiny_Octo_Journey_Custom_UIKIT_Widget_Class $this     Current Custom HTML widget instance.
         */
     ...
     *
     * @since 4.8.1
     * @since 4.9.0 The form contains only hidden sync inputs. For the control UI, see `Shiny_Octo_Journey_Custom_UIKIT_Widget_Class::render_control_template_scripts()`.
     *
     * @see Shiny_Octo_Journey_Custom_UIKIT_Widget_Class::render_control_template_scripts()
